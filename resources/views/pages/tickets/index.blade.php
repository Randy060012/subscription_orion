    ...
    <div class="card shadow-sm border-0 bg-white">
        <div class="card-header bg-white py-3 border-0 d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            <div class="btn-toolbar text-nowrap">
                ...
                <button type="button" class="btn btn-custom-outline btn-custom-outline-sm" data-bs-toggle="modal" data-bs-target="#createTicketModal">
                    <i class="fa-solid fa-plus me-1"></i> Créer un Ticket
                </button>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="ticketsTable" class="table table-hover align-middle w-100">
                    ...
                    <tbody>
                        <tr>
                            <td class="text-nowrap"><strong class="text-primary">TCK-2026-001</strong></td>
                            <td class="td-truncate" title="Erreur lors de la validation des contrats">
                                <div class="fw-bold text-truncate">Erreur lors de la validation des contrats</div>
                                <span class="text-muted small d-block text-truncate">Demandeur : Koffi Mensah (+228 90 11 22 33)</span>
                            </td>
                            <td class="text-nowrap"><span class="badge bg-danger bg-opacity-10 text-danger border border-danger border-opacity-25"><i class="fa-solid fa-bug me-1"></i>Bug</span></td>
                            <td class="text-nowrap">Agence Lomé Centre</td>
                            <td class="text-nowrap"><span class="badge bg-danger">Haute</span></td>
                            <td class="text-nowrap"><span class="badge bg-warning text-dark">En cours</span></td>
                            <td class="text-nowrap">23/07/2026 14:30</td>
                            <td class="text-end text-nowrap">
                                <div class="action-btns">
                                    <button class="btn btn-sm btn-outline-secondary" title="Voir détails"><i class="fa-solid fa-eye"></i></button>
                                    <button class="btn btn-sm btn-outline-primary" title="Modifier / Mettre à jour"><i class="fa-solid fa-pen"></i></button>
                                    <button class="btn btn-sm btn-outline-danger" title="Fermer / Archiver"><i class="fa-solid fa-box-archive"></i></button>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-nowrap"><strong class="text-primary">TCK-2026-002</strong></td>
                            <td class="td-truncate" title="Demande de formation sur l'export PDF">
                                <div class="fw-bold text-truncate">Demande de formation sur l'export PDF</div>
                                <span class="text-muted small d-block text-truncate">Demandeur : Amevi Dosseh</span>
                            </td>
                            <td class="text-nowrap"><span class="badge bg-info bg-opacity-10 text-info border border-info border-opacity-25"><i class="fa-solid fa-graduation-cap me-1"></i>Formation</span></td>
                            <td class="text-nowrap">Agence Kara</td>
                            <td class="text-nowrap"><span class="badge bg-secondary">Moyenne</span></td>
                            <td class="text-nowrap"><span class="badge bg-info text-dark">En attente</span></td>
                            <td class="text-nowrap">23/07/2026 11:15</td>
                            <td class="text-end text-nowrap">
                                <div class="action-btns">
                                    <button class="btn btn-sm btn-outline-secondary" title="Voir détails"><i class="fa-solid fa-eye"></i></button>
                                    <button class="btn btn-sm btn-outline-primary" title="Modifier / Mettre à jour"><i class="fa-solid fa-pen"></i></button>
                        ...
                        <tr>
                            <td class="text-nowrap"><strong class="text-primary">TCK-2026-003</strong></td>
                            <td class="td-truncate" title="Ajout d'un filtre par date dans la recherche">
                                <div class="fw-bold text-truncate">Ajout d'un filtre par date dans la recherche</div>
                                <span class="text-muted small d-block text-truncate">Demandeur : Yao Kouma</span>
                            </td>
                            <td class="text-nowrap"><span class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25"><i class="fa-solid fa-lightbulb me-1"></i>Amélioration</span></td>
                            <td class="text-nowrap">Agence Kpalimé</td>
                            <td class="text-nowrap"><span class="badge bg-success">Basse</span></td>
                            <td class="text-nowrap"><span class="badge bg-success">Résolu</span></td>
                            <td class="text-nowrap">22/07/2026 09:00</td>
                            <td class="text-end text-nowrap">
                                <div class="action-btns">
                                    <button class="btn btn-sm btn-outline-secondary" title="Voir détails"><i class="fa-solid fa-eye"></i></button>
                                    <button class="btn btn-sm btn-outline-primary" title="Modifier / Mettre à jour"><i class="fa-solid fa-pen"></i></button>
        ...
        $(document).ready(function() {
            $('#ticketsTable').DataTable({
                ...
                columnDefs: [
                    ...
                    { className: "text-nowrap", targets: [0, 2, 4, 5, 6, 7] }
                ]
            });
        });
    </script>
